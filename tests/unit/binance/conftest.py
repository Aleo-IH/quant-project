...
class FakeSpotClient:
    ...
    def _gen_klines(self, symbol, interval, limit, startTime=None):
        ...
        for i in range(limit):
            ...
            out.append([
                ...
                t + step - 1, vol * close, 5 + i, vol/2, vol*close/2, 0
            ])
            t += step
    ...
    def depth(self, symbol, limit=100):
        return {"lastUpdateId": 1, "bids": [["100.0","1.0"]], "asks": [["101.0","2.0"]]}
    ...
    def account(self):
        return {"balances": [{"asset":"BTC","free":"0.5","locked":"0"}, {"asset":"USDT","free":"1000","locked":"0"}]}

    def new_order(self, symbol, side, type, quantity, **kwargs):
        return {"symbol": symbol, "side": side, "type": type, "status": "FILLED", "orderId": 123}
    ...
    def my_trades(self, symbol, limit=50):
        return [{"symbol":symbol,"id":i,"price":"100.5","qty":"0.01"} for i in range(limit)]
